...
namespace opengl_series
{
    ...
    public class MainClass
    {
        ...
        private static void LoadWoodenCrateAsset()
        {
            ...
            GL.VertexAttribPointer(_gWoodenCrate.Shaders.Attrib("vert"), 3, VertexAttribPointerType.Float, false, 5 * sizeof(float), 0);

            // connect the uv coords to the "vertTexCoord" attribute of the vertex shader
            GL.EnableVertexAttribArray(_gWoodenCrate.Shaders.Attrib("vertTexCoord"));
            GL.VertexAttribPointer(_gWoodenCrate.Shaders.Attrib("vertTexCoord"), 2, VertexAttribPointerType.Float, true, 5 * sizeof(float), 3 * sizeof(float));
