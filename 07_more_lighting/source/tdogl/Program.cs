...
namespace tdogl
{
    ...
    public class Program: IDisposable
    {
        ...
        public void SetUniform(string uniformName, ref Matrix matrix, bool transpose = false)
        {
            GL.UniformMatrix4(Uniform(uniformName), transpose, ref matrix);
        }

        public void SetUniform(string uniformName, Vector3 value)
        {
            GL.Uniform3(Uniform(uniformName), value);
        }
